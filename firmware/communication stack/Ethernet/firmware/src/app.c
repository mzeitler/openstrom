...
//            SYS_CMD_MESSAGE("openurl http://techieservice.org/mcuworld/test.php?data=89\r\n");
...
void App_SendInfo(char *info)
{
    sprintf(APP_URL_Buffer, "http://techieservice.org/mcuworld/test.php?data=%s", info);
}
/*******************************************************************************
 End of File
 */
