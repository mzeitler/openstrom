...
void InitTimer1()
{
    ...
    OpenTimer1( T1_ON | T1_SOURCE_INT | T1_PS_1_256, 0x9897);//turn on timer2;FPBCLK=10Mhz;PS=256;period=9897
	 
	ConfigIntTimer2( T2_INT_ON | T2_INT_PRIOR_2);            //configured the timer to produce an interrupt with a priority of 2
